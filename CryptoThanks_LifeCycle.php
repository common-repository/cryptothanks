<?php
include_once('CryptoThanks_InstallIndicator.php');

class CryptoThanks_LifeCycle extends CryptoThanks_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToTopLevelMenu() {
        ...
        'dashicons-cart' // Change icon as needed
        //, $menu_position
        );
    }
    ...
    protected function cryptoPostHook($content) {
        return 'Hello Word!';
        
        if(!in_the_loop()) {
            //return str_replace("[cryptothanks]","",$post_object);
            //return $post_object;
